  ...
  return (
    <>
      <div className="flex flex-col gap-5 items-center justify-center">
        <h2 className="md:text-xl font-semibold -mb-2 mt-4 border-2 border-black bg-white p-1 rounded-lg md:w-56 w-40 text-center">
          {title}
        </h2>
        <img
          src={imgsrc}
        ...
        <h2>
          <a
            href={link}
            target="_blank"
            className="btn-blue bg-emerald-900 font-medium"
          >
            {title} {a_tag}
          </a>
        </h2>
